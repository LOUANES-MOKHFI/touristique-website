        ...
        <div class="col-12">
          <div class="card">
             <div class="card-header row">
              <h3 class="card-title col-md-2 col-sm-6">Liste des Administrateurs</h3>
              <form class="card card-sm col-md-7 col-sm-6" action="{{url('/search-admin')}}" method="get">
        {{ csrf_field()}}
         <div class=" row no-gutters align-items-center">
            ...
            <div class="col-auto">
             ...
             <div class="col-md-3 col-sm-6">
                <a href="{{url('/admin/admin/create')}}" class="btn btn-primary float-right"><i class="fas fa-plus"></i>Ajouter une admin</a>
             </div>
            </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>{{$user1->name}}</td>
                  <td>{{$user1->email}}</td>
                  <td>{{$user1->is_admin = 1 ? 'Admin' : 'Membre' }}</td>
                  <td>
                    <a class="btn btn-info fa fa-eye-slash" href="{{'/admin/admin/'.$user1->id}}"></a>
                    <a class="btn btn-warning fa fa-btn fa-edit" href="{{'/admin/admin/'.$user1->id.'/edit'}}"></a>
                        {{ csrf_field()}}
                        {{ method_field('DELETE') }}
                       @if($user1->id != 1)
                        <a class="btn btn-danger far fa-trash-alt" href="{{'/admin/admin/'.$user1->id.'/delete'}}"></a>
                       @endif 
                  </td>
                </tr>
